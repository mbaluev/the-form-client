...
import { TabMaterials } from '@ui/pages/admin/settings/userBlock/[id]/tabs/tabMaterials';
import { TabTasks } from '@ui/pages/admin/settings/userBlock/[id]/tabs/tabTasks';
import { TabQuestions } from '@ui/pages/admin/settings/userBlock/[id]/tabs/tabQuestions';
