...
import { BlockTabs } from '@ui/pages/admin/settings/block/blockTabs';
import { BlockCardActions } from '@ui/pages/admin/settings/block/blockCardActions';
import { BlockLabel } from '@ui/pages/admin/settings/block/blockLabel';
