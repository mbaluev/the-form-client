...
import { TabMaterials } from '@ui/pages/admin/userBlock/[id]/tabs/tabMaterials';
import { TabTasks } from '@ui/pages/admin/userBlock/[id]/tabs/tabTasks';
import { TabQuestions } from '@ui/pages/admin/userBlock/[id]/tabs/tabQuestions';
