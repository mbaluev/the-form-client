...
import { MaterialCardContent } from '@ui/pages/admin/userBlock/[id]/tabs/tabMaterials/materialCardContent';
import { MaterialCardActions } from '@ui/pages/admin/userBlock/[id]/tabs/tabMaterials/materialCardActions';
