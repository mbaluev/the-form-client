...
import { ModuleTabs } from '@ui/pages/admin/module/moduleTabs';
import { ModuleCardActions } from '@ui/pages/admin/module/moduleCardActions';
import { ModuleLabel } from '@ui/pages/admin/module/moduleLabel';
