...
export const TaskList = observer(() => {
  ...
  const itemsRight: JSX.Element[] = [
    <IconButton tooltip="Add new homework task" onClick={modalNew}>
      <AddIcon />
    </IconButton>,
    <IconButton
      tooltip="Delete homework tasks"
    ...
    <React.Fragment>
      <GridWithData
        ...
        propsGrid={{
          ...
          noDataMessage: 'No homework tasks found',
      ...
      <DialogConfirm
        ...
        title="Delete homework tasks"
        message="Are you sure you want to delete selected homework tasks?"
      />
      <DialogTask
        isOpen={isModalOpen}
        onClose={modalClose}
