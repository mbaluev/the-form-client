...
import { Title } from '@ui/pages/settings/module/item/title';
import { Quick } from '@ui/pages/settings/module/item/quick';
...
import { SubTitle } from '@ui/pages/settings/module/item/subtitle';
import { Tabs } from '@ui/pages/settings/module/item/tabs';
import { Separator } from '@ui/pages/settings/module/item/separator';
...
export const PageModule = observer(() => {
  ...
  const isCreate = router.pathname === ROUTES.SETTINGS_MODULE_CREATE.path;
