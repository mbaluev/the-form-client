...
import { TaskBaseDocumentStore } from '@store/modules/_/task/baseDocument';
import { STORE } from '@store/ids';
import type ITaskAdminDocumentStore from '@store/modules/_/task/adminDocument/interface';
